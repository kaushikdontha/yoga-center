      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="w-full lg:w-1/4 mb-8 lg:mb-0">
            ...
            <div className="flex flex-col space-y-2 md:space-y-0 md:flex-row md:flex-wrap md:gap-x-4 md:gap-y-2 text-gray-300">
              <p>Sri Durga Estates ground Quthbullapur, Hyderabad Telangana 500067 India</p>
                Email: <a href="mailto:info@raviyoga.com" className="hover:text-orange-400 whitespace-nowrap">info@raviyoga.com</a>
              <p>
                Phone: <a href="tel:+919876543210" className="hover:text-orange-400 whitespace-nowrap">+91 98765 43210</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center gap-6 mb-8">
          <a
            href="https://www.facebook.com/share/1CaSL7Memw/"
            target="_blank"
          ...
          <a
            href="https://www.youtube.com/@raviyogacenter"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-orange-400 transition-colors"
            aria-label="YouTube"
