      ...
      <nav className="container mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
            ...
            <Link
              to="/book-trial"
              className="bg-orange-400 hover:bg-orange-500 text-white px-4 lg:px-6 py-2 rounded-lg 
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              {navLinks.map((link) => (
                <Link
                  key={link.path}
                  to={link.path}
                  className={`block font-medium px-4 py-3 rounded-lg transition-colors text-base ${
                    isActive(link.path)
              ...
              <Link
                to="/book-trial"
                className="block bg-orange-400 hover:bg-orange-500 text-white px-4 py-3 rounded-lg 
                         font-medium transition-colors text-center mx-4 my-2 text-base"
                onClick={toggleMenu}
              >
                Try a Free Class
              </Link>
